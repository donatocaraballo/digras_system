...
const styles = {
    ...
    tableWrapper: { borderRadius: '12px', border: '1px solid #e2e8f0', overflowX: 'auto', boxShadow: '0 2px 10px rgba(0,0,0,0.03)' },
    table: { width: "100%", borderCollapse: "collapse", fontSize: "0.9rem", minWidth: "600px" }, // Min width para scroll horizontal
    ...
    searchSection: { backgroundColor: '#f8fafc', padding: '20px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '25px', display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap' },
    ...
    modalOverlay: { position: "fixed", inset: 0, background: "rgba(15, 23, 42, 0.6)", backdropFilter: "blur(4px)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 4000, padding: '20px' },
    modal: { width: "100%", maxWidth: "500px", background: "#ffffff", borderRadius: "20px", boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.25)", padding: "35px", boxSizing: "border-box", maxHeight: '90vh', overflowY: 'auto' },
        ...
        <div style={styles.container} className="responsive-container">
                ...
                <div style={styles.titleGroup}>
                    ...
                    <div>
                        ...
                        <p style={styles.subtitle}>
                            {esGerencia ? "Gestión global de cartera." : "Gestiona tu cartera."}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div style={styles.content} className="responsive-content">
                ...
                <div style={styles.searchSection} className="responsive-search">
                    ...
                    <div style={{display:'flex', gap: 10, width: '100%', justifyContent: 'flex-end'}} className="responsive-buttons">
                        ...
                        <div style={{display:'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap:'30px'}}>
                            <div>
                                {esGerencia && (
                                    <div style={styles.resumenLine}>
                                        <span style={{fontWeight:'600', color:'#64748b'}}>Vendedor</span> 
                            ...
                            <div>
                                <div style={styles.resumenLine}>
                                    ...
                                    <span style={{maxWidth:'60%', textAlign:'right'}}>{clienteSeleccionado.direccion || "-"}</span>
                                </div>
                                <div style={styles.resumenLine}>
