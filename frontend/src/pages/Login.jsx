...
const styles = {
    ...
    inputGroup: { display: 'flex', alignItems: 'center', backgroundColor: '#ffffff', borderRadius: '12px', padding: '5px 15px', border: '2px solid transparent', boxShadow: '0 2px 10px rgba(0,0,0,0.05)', transition: 'all 0.3s ease' },
    inputGroupFocus: { borderColor: '#0d47a1', boxShadow: '0 4px 15px rgba(13, 71, 161, 0.2)', transform: 'translateY(-2px)' },
    icon: { fontSize: '1.2rem', marginRight: '10px', opacity: 0.5, color: '#0d47a1' },
    input: { width: '100%', padding: '12px 0', border: 'none', outline: 'none', fontSize: '1rem', color: '#333', fontWeight: '500', background: 'transparent' },
    errorBox: { backgroundColor: '#ffebee', color: '#c62828', padding: '12px', borderRadius: '8px', fontSize: '0.9rem', fontWeight: '600', borderLeft: '4px solid #c62828', textAlign: 'left', lineHeight: '1.4' },
    button: { marginTop: '10px', padding: '15px', borderRadius: '12px', border: 'none', background: 'linear-gradient(135deg, #0d47a1 0%, #d32f2f 100%)', color: 'white', fontSize: '1.1rem', fontWeight: 'bold', letterSpacing: '1px', cursor: 'pointer', boxShadow: '0 6px 20px rgba(13, 71, 161, 0.4)', transition: 'transform 0.2s, box-shadow 0.2s', textTransform: 'uppercase' },
